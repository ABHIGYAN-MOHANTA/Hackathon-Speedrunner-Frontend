...
Welcome to the Hackathon-Speedrunner-Frontend repository! This project is a one-stop solution for tracking hackathons and team building. It serves as the frontend component of the Hackathon Speedrunner Backend project.

![Project Logo](https://github.com/ABHIGYAN-MOHANTA/Hackathon-Speedrunner-Backend-v1.0.2/assets/110360901/2d7aa60a-6796-4deb-b31f-6c66654a3c11)
...
Hackathon-Speedrunner-Frontend is built using React, Redux Toolkit, RTK Query, and Tailwind CSS. It provides users with information about tech events and hackathons happening around them, as well as a platform to chat and form teams. Users can even post about events that are not currently tracked by our backend.

![Project Screenshots](https://github.com/ABHIGYAN-MOHANTA/Hackathon-Speedrunner-Backend-v1.0.2/assets/110360901/1a780c9c-0b6d-45e7-8280-a226b27f394c)
...
If you encounter any issues or have any questions regarding the Hackathon-Speedrunner-Frontend project, please feel free to [open an issue](https://github.com/ABHIGYAN-MOHANTA/Hackathon-Speedrunner-Frontend/issues) on GitHub. We'll be happy to assist you!

Happy hacking!

![Project Screenshots](https://github.com/ABHIGYAN-MOHANTA/Hackathon-Speedrunner-Backend-v1.0.2/assets/110360901/36bcbe13-84b2-44e7-94fb-53442aa2969c)
